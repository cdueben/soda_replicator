...
curl -s https://raw.githubusercontent.com/cdueben/soda_replicator/main/skills/replication-compliance/SKILL.md | head -15
```
...
cd soda_replicator_dev-update && bash skills/replication-compliance/install.sh && \
